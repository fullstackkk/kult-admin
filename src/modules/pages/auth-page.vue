...
<template>
  <div
    class="flex w-full items-center justify-between overflow-hidden dark:bg-[#191D23]"
  >
    <img
      :src="authBg"
    ...
    <div class="flex h-screen flex-1 flex-col items-center justify-center">
      <div class="flex flex-col items-center justify-start gap-[10px]">
        <h3 class="text-[26px] font-bold text-textprimary dark:text-[#E4E4E4]">
          Автошкола
        </h3>
        <h4
          class="text-[18px] font-normal text-textprimary dark:text-[#E4E4E4]"
        >
          Культура Вождения
        </h4>
      </div>
